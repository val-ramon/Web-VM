...
#    ax.plot(x+i/10.0,'.')
    ...
    #    ax1.set_ylim([0,0.025])
        ...
        try:
            os.remove('C:/Users/edomene/Downloads/bokeh_flask/bokeh_flask/static/estado/osciloscopio'+str(i - 2).zfill(10)+'.png')
        except:
            pass
        fig.savefig('C:/Users/edomene/Downloads/bokeh_flask/bokeh_flask/static/estado/osciloscopio'+str(i).zfill(10)+'.png')
        i += 1
